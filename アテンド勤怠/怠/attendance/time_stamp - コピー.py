...
# ログイン後の表示ページ
#------------------------------------------------
@app.route('/time_stamp', methods=["GET","POST"])
...
#    db_time = Time.query.all()
    print("time_stampデバッグ１ = ",number,today,today_record)
...
# 編集ページ
#------------------------------------------------
@app.route('/time_modify', methods=["GET","POST"])
@login_required                                  #ログイン必須にしたい関数の前に記述する
